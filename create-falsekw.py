...
for row in cur.execute("SELECT Word1, Word2 FROM heyjarvis"):
    print(row[0] + row[1], lang, speaker)
    ...
    if lang != "hi" and lang != "ko":
        tts.tts_to_file(text=row[0] + ' ' + row[1],
                                file_path="falsekw/" + row[0] + row[1] + ".wav",
                                speaker=speaker,
                                language=lang,
